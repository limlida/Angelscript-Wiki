...
- `TSoftObjectPtr<USkinnedAsset> SkinnedAsset []`
- `TSoftObjectPtr<UTransformProviderData> TransformProvider []`
...
- `FSoftSkinnedMeshComponentDescriptor& opAssign(FSoftSkinnedMeshComponentDescriptor Other)`
