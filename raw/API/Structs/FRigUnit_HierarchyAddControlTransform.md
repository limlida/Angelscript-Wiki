...
- `FTransform InitialValue [* The initial value of the new control]`
...
- `FRigUnit_HierarchyAddControlTransform_Settings Settings [* The settings for the control]`


**方法**:

- `FRigUnit_HierarchyAddControlTransform& opAssign(FRigUnit_HierarchyAddControlTransform Other)`
