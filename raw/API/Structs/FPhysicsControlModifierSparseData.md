...
- `bool bEnableCollisionType`
- `bool bEnableGravityMultiplier`
- `bool bEnableKinematicTargetSpace`
- `bool bEnableMovementType`
- `bool bEnablePhysicsBlendWeight`
- `bool bEnablebUpdateKinematicFromSimulation`
...
parts of the skeleton from being torn apart. Note - this is not used in RBWC]`


**方法**:

- `FPhysicsControlModifierSparseData& opAssign(FPhysicsControlModifierSparseData Other)`
