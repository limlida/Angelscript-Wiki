...
- `bool bOverrideCullProxySettings [Controls whether we override the cull proxy settings.]`
- `bool bOverrideDistanceSettings [Controls whether we override the distance culling settings.]`
- `bool bOverrideGlobalBudgetScalingSettings [Controls whether we override the global budget scaling settings.]`
- `bool bOverrideInstanceCountSettings [Controls whether we override the instance count culling settings.]`
- `bool bOverridePerSystemInstanceCountSettings [Controls whether we override the per system instance count culling settings.]`
- `bool bOverrideVisibilitySettings [Controls whether we override the visibility culling settings.]`
