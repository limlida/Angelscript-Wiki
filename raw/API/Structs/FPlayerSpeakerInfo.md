...
- `UNarrativeDialogueSequence SelectingReplyShot [Sequence to play when player is selecting their reply, overrides SelectingReplyShot]`
...
- `FPlayerSpeakerInfo& opAssign(FPlayerSpeakerInfo Other)`
