...
- `FVector Value [The current value of the animation channel]`
- `bool bInitial [If set to true the initial value will be returned]`


**方法**:

- `FRigUnit_GetVectorAnimationChannelFromItem& opAssign(FRigUnit_GetVectorAnimationChannelFromItem Other)`
