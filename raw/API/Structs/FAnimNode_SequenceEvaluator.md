...
- `int ExplicitFrame [The frame at which to evaluate the associated sequence]`
...
- `bool bUseExplicitFrame [Whether to use ExplicitFrame (true) or ExplicitTime (false) when evaluating the associated sequence]`
