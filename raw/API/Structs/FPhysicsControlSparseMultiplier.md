...
- `bool bEnableAngularDampingRatioMultiplier`
- `bool bEnableAngularExtraDampingMultiplier`
- `bool bEnableAngularStrengthMultiplier`
- `bool bEnableLinearDampingRatioMultiplier`
- `bool bEnableLinearExtraDampingMultiplier`
- `bool bEnableLinearStrengthMultiplier [Flags for sparse access]`
- `bool bEnableMaxForceMultiplier`
- `bool bEnableMaxTorqueMultiplier`


**方法**:

- `FPhysicsControlSparseMultiplier& opAssign(FPhysicsControlSparseMultiplier Other)`
