...
- `UGroomCache GroomCache [The animation this section plays]`
...
- `FMovieSceneGroomCacheSectionTemplateParameters& opAssign(FMovieSceneGroomCacheSectionTemplateParameters Other)`
