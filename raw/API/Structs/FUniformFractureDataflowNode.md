...
- `bool GroupFracture [Generate a fracture pattern across all selected meshes.]`
- `float32 Grout [Amount of space to leave between cut pieces]`
- `int InternalMaterialID [ID for the material for the newly created internal faces]`
...
- `int MaxVoronoiSites [Maximum Number of Voronoi sites. The amount of sites per Voronoi diagram will be chosen at random between Min and Max]`
- `int MinVoronoiSites [Minimum Number of Voronoi sites. The amount of sites per Voronoi diagram will be chosen at random between Min and Max]`
...
- `FUniformFractureDataflowNode& opAssign(FUniformFractureDataflowNode Other)`
