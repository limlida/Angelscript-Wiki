...
- `UAudioBus AudioBus [The Audio Bus to send the audio to]`
...
- `float32 MaxSendLevel [The amount to send to the bus when sound is located at a distance greater than or equal to value specified in the Max Send Distance]`
...
- `float32 MinSendLevel [The amount to send to the bus when sound is located at a distance less than or equal to value specified in the Min Send Distance]`
- `float32 SendLevel [Manually set the amount of audio to send to the bus]`
- `USoundSourceBus SoundSourceBus [The Source Bus to send the audio to]`
- `ESourceBusSendLevelControlMethod SourceBusSendLevelControlMethod [Manual: Use Send Level only
