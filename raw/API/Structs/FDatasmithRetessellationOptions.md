...
- `EDatasmithCADRetessellationRule RetessellationRule [Regenerate deleted surfaces during retesselate or ignore them]`
...
- `FDatasmithRetessellationOptions& opAssign(FDatasmithRetessellationOptions Other)`
