...
- `FFloatInterval SamplingRange [It allows users to set a time range to an individual animation sequence in the database.
...
- `FPoseSearchDatabaseSequence& opAssign(FPoseSearchDatabaseSequence Other)`
