...
- `FVector InitialValue [* The initial value of the new control]`
...
- `FRigUnit_HierarchyAddControlVector_Settings Settings [* The settings for the control]`


**方法**:

- `FRigUnit_HierarchyAddControlVector& opAssign(FRigUnit_HierarchyAddControlVector Other)`
