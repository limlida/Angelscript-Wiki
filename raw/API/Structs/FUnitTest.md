...
- `AdvanceTime(float32 DeltaSecs)`
- `AddExpectedError(FString Regex, int Occurrences = 1)`
- `CallNativeBeginPlayFor(AActor Actor, bool bFromLevelStreaming = false)`
- `CallNativeBeginPlayFor(UActorComponent ActorComponent)`
- `SetIsServer(bool bIsServer)`
- `FString GetParam()`
