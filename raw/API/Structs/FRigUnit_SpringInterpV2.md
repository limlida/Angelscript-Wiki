...
- `float32 Current [Current position of the spring.]`
- `float32 Force [Extra force to apply (since the mass is 1, this is also the acceleration).]`
- `float32 Result [New position of the spring after delta time.]`
...
- `float32 Target [Rest/target position of the spring.]`
