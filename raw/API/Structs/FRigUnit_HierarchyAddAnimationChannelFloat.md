...
- `float32 InitialValue [* The initial value of the new animation channel]`
...
- `float32 MaximumValue [* The maximum value for the animation channel]`
- `float32 MinimumValue [* The initial value of the new animation channel]`
...
- `FRigUnit_HierarchyAddAnimationChannelFloat& opAssign(FRigUnit_HierarchyAddAnimationChannelFloat Other)`
