...
- `int InitialValue [* The initial value of the new control]`
...
- `FRigUnit_HierarchyAddControlInteger_Settings Settings [* The settings for the control]`


**方法**:

- `FRigUnit_HierarchyAddControlInteger& opAssign(FRigUnit_HierarchyAddControlInteger Other)`
