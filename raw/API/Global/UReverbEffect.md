...
- `float32 Density [Density - 0.0 < 1.0 < 1.0 - Coloration of the late reverb - lower value is more grainy]`
- `float32 Diffusion [Diffusion - 0.0 < 1.0 < 1.0 - Echo density in the reverberation decay - lower is more grainy]`
