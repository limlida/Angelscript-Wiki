...
- `UMovieSceneScriptingStringKey AddKey(FFrameNumber InTime, FString NewValue, float32 SubFrame = 0.000000, EMovieSceneTimeUnit TimeUnit = EMovieSceneTimeUnit :: DisplayRate)`  
...
- `SetDefault(FString InDefaultValue)`  
...
@param       DeltaFrame          The amount to offset the keys by
