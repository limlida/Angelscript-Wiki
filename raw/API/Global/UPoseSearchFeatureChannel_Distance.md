...
- `float32 MaxDistance [Experimental, this feature might be removed without warning, not for production use
...
- `float32 GetDistance(FChooserEvaluationContext& Context) const`
