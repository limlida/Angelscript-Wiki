...
- `UMovieSceneScriptingParticleKey AddKey(FFrameNumber InTime, EParticleKey NewParticleValue, float32 SubFrame = 0.000000, EMovieSceneTimeUnit TimeUnit = EMovieSceneTimeUnit :: DisplayRate)`  
...
- `SetDefault(EParticleKey InDefaultValue)`  
