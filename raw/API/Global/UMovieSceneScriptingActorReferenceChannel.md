...
- `UMovieSceneScriptingActorReferenceKey AddKey(FFrameNumber InTime, FMovieSceneObjectBindingID NewValue, float32 SubFrame = 0.000000, EMovieSceneTimeUnit TimeUnit = EMovieSceneTimeUnit :: DisplayRate)`  
...
- `SetDefault(FMovieSceneObjectBindingID InDefaultValue)`  
