...
- `UMovieSceneScriptingTextKey AddKey(FFrameNumber InTime, FText NewValue, float32 SubFrame = 0.000000, EMovieSceneTimeUnit TimeUnit = EMovieSceneTimeUnit :: DisplayRate)`  
...
@return      An array of UMovieSceneScriptingTextKey's contained by this channel.
...
- `SetDefault(FText InDefaultValue)`  
