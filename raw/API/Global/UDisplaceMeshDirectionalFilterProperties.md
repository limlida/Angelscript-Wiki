...
- `FVector FilterDirection [Unit vector representing the direction to filter along.]`
- `float32 FilterWidth [Scalar value determining how close to the filter direction the vertex normals must be in order to be displaced.
