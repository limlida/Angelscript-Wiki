...
- `UMovieSceneScriptingBoolKey AddKey(FFrameNumber InTime, bool NewValue, float32 SubFrame = 0.000000, EMovieSceneTimeUnit TimeUnit = EMovieSceneTimeUnit :: DisplayRate)`  
...
- `SetDefault(bool InDefaultValue)`  
