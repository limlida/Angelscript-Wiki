...
- `int LoopCount [The amount of times to loop]`
- `bool bLoopIndefinitely [If enabled, the node will continue to loop indefinitely regardless of the Loop Count value.]`
