...
- `UMovieSceneScriptingDoubleKey AddKey(FFrameNumber InTime, float NewValue, float32 SubFrame = 0.000000, EMovieSceneTimeUnit TimeUnit = EMovieSceneTimeUnit :: DisplayRate, EMovieSceneKeyInterpolation InInterpolation = EMovieSceneKeyInterpolation :: Auto)`  
...
- `SetDefault(float InDefaultValue)`  
